...
default['sufia']['directory'] = "#{node['user']['dir']}/sufia"
...
default['fits']['installpath'] = "#{node['user']['dir']}/fits"
default['fits']['shellpath'] = "#{node['user']['dir']}/fits/fits.sh"
default['fits']['techmd_dsid'] = "TECHMD_FITS"

# redis specific
default['redis']['version'] = "3.0.3"
default['redis']['sha256'] = '1D08FA665B16D0950274DFBD47FBBCF3485E43E901021338640A0334666E9DA5'
default['redis']['web-dir'] = "http://download.redis.io/releases/redis-"
